...
final class ApiCest
{
    ...
    public function testGetStreamsWithInvalidRadioName(ApiTester $I): void
    {
        ...
        $I->seeResponseIsJson();
        $I->seeResponseContainsJson(['detail' => 'Invalid radio name given: foobar']);
    }
    ...
    public function testGetStreamInfoWithInvalidRadioName(ApiTester $I): void
    {
        ...
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
        $I->seeResponseIsJson();
        $I->seeResponseContainsJson(['detail' => 'Invalid radio name given: foo']);
    }
    ...
    public function testGetStreamInfoWithInvalidStreamName(ApiTester $I): void
    {
        ...
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
        $I->seeResponseIsJson();
        $I->seeResponseContainsJson(['detail' => 'Invalid stream name given: bar']);
    }
}
